...
public class CommandHandler implements Serializable {
    ...
    public String regex = ("(?:[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*|\"" +
    ...
    public String init(SocketDto input) throws IOException, ArrayIndexOutOfBoundsException {
        ...
        return "Unexpected command. Try again.";
    }
}
