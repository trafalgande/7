...
public class DataBaseManager implements Serializable {
    ...
    private String username = "s263068";
    private String password = "zet761";
    ...
    public String add(String fname, String sname, int age) {
        if (currentUser.getAccountName() != null) {
            try (PreparedStatement preparedStatement = connection.prepareStatement
                ...
                prs.setString(2, encryptor.encryptThisString(currentUser.getAccountPassword()));
                ResultSet rs = prs.executeQuery();
                while (rs.next()) {
